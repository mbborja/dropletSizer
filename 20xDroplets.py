...
# Omkar 20x \w 1.5x Droplet
# droplets = io.imread("Z:/Omkar_Hegde/21_6/65_deg_20X/20_06_20X/Default/img_channel000_position000_time000000000_z000.tif")
...
# Gaussian on the original image
gauss = filters.gaussian(droplets, sigma = 1)
#%%
##Canny Edge Detector
